export function Navbar() {
    return (
        <div className="w-2/5 flex flex-col justify-between py-3">
            <div className="">
...
function NavButton({ icon, selected, text }) {
    return (
        <div className="p-3 my-1 flex flex-row items-center rounded-full hover:bg-grey-4 cursor-pointer duration-200">
